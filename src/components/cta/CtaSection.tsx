...
import { CTA_DEFAULTS } from './CtaSection.constants';
...
export default function CtaSection({
  badgeText = CTA_DEFAULTS.badgeText,
  title = CTA_DEFAULTS.title,
  subtitle = CTA_DEFAULTS.subtitle,
  primaryLabel = CTA_DEFAULTS.primaryLabel,
  secondaryLabel = CTA_DEFAULTS.secondaryLabel,
  onPrimaryClick,
  onSecondaryClick,
  primaryIcon,
  'data-testid': dataTestId,
}: CtaSectionProps) {
  const PrimaryLeadingIcon = primaryIcon ?? <SparklesIcon />;

  return (
    <CtaRoot data-testid={dataTestId}>
      <AccentCircleTop />
      <AccentCircleBottom />
      <IconGhost>
        <BrainGhost />
