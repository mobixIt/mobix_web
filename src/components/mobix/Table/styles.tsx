// src/components/mobix/table/MobixTable.styles.tsx
import { styled } from '@mui/material/styles';
import { Box, Paper, Typography } from '@mui/material';

/** Root container for the whole MobixTable block */
...
/** Paper that wraps the MUI Table + pagination */
...
/** Toolbar when NO rows are selected */
