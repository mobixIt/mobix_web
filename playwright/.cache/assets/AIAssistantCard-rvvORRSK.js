...
const aiAssistantDefaults = {
  title: "Asistente IA",
  subtitle: "Haz preguntas sobre tus datos y operaciones",
  suggestionTitle: "Se detectó una consulta de datos históricos",
  suggestionBody: "Tu consulta parece requerir análisis histórico. Podemos generar un reporte con tendencias e insights.",
  primaryActionLabel: "ABRIR REPORTE HISTÓRICO",
  secondaryActionLabel: "VER EN ANALYTICS",
  inputPlaceholder: "Haz preguntas sobre métricas, desempeño, tendencias o estados de tus datos...",
  tipText: 'Tip: Pregunta "Muéstrame los items con bajo rendimiento" o "¿Qué registros tienen mejor historial de cumplimiento?"'
};
...
const HeaderTitleGroup = styled(Box)(() => ({
  display: "flex",
  alignItems: "center",
  gap: 12
}));
...
const SuggestionIcon = styled(Box)(({ theme }) => ({
  width: 52,
  height: 52,
  borderRadius: theme.shape.borderRadius,
  backgroundColor: theme.palette.background.paper,
...
const SuggestionActions = styled(Box)(({ theme }) => ({
  display: "flex",
  alignItems: "center",
  gap: theme.spacing(2),
  flexWrap: "wrap",
...
const QuestionInput = styled(InputBase)(({ theme }) => ({
  flex: 1,
  fontSize: theme.typography.body1.fontSize,
...
const TipRow = styled(Box)(({ theme }) => ({
  display: "flex",
  alignItems: "center",
  gap: theme.spacing(1),
  color: theme.palette.text.secondary
}));
const TextMuted = styled(Typography)(({ theme }) => ({
  color: theme.palette.text.secondary
}));
...
const FaClockRotateLeftIcon = createFaIcon(faClockRotateLeft, "clock-rotate-left");
const FaFileLinesIcon = createFaIcon(faFileLines, "file-lines");
const FaChartLineIcon = createFaIcon(faChartLine, "chart-line");
const FaPaperPlaneIcon = createFaIcon(faPaperPlane, "paper-plane");
...
"use client";
const MobixButtonSmall = styled(MobixButton)(() => ({
  height: 40,
  borderRadius: 2
}));
...
const MobixButtonOutlined = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(
...
"use client";
const MobixButtonText = styled(Button)(
  ({ size = "medium" }) => {
...
"use client";
const MobixButtonLink = styled("button")(({ theme }) => ({
  border: 0,
  backgroundColor: "transparent",
  color: theme.palette.primary.main,
  cursor: "pointer",
...
"use client";
const MobixButtonDelete = styled(MobixButtonText)(({ theme }) => ({
  color: theme.palette.error.main,
  "&:hover": {
...
"use client";
const MobixButtonSecondaryAction = styled(MobixButton)(() => ({
  "& .MuiButton-label": {
    fontSize: "16px",
    fontWeight: "bold",
    letterSpacing: "0.5px",
...
function MobixIconButton({
  icon,
  iconPosition = "left",
  children,
  ...props
}) {
  const startIcon = iconPosition === "left" ? icon : void 0;
  const endIcon = iconPosition === "right" ? icon : void 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    MobixIconButtonRoot,
    {
      ...props,
...
const AiSendButton = ({ isLoading = false, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsx(StyledIconButton, { isLoading, ...props, disabled: isLoading || props.disabled, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
...
function AIAssistantCard({
  ...
  const [question, setQuestion] = reactExports.useState(defaultQuestion);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardRoot, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(HeaderTitleGroup, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(IconContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaBrainIcon, { color: "primary", fontSize: "medium" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h6", fontWeight: 700, color: "text.primary", children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TextMuted, { variant: "body2", children: subtitle })
      ] })
    ] }) }),
    hasSuggestion ? /* @__PURE__ */ jsxRuntimeExports.jsx(SuggestionCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SuggestionContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SuggestionIcon, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaClockRotateLeftIcon, { color: "primary", fontSize: "medium" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SuggestionHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            suggestionTitle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle1", fontWeight: 700, color: "text.primary", children: suggestionTitle }) : null,
            suggestionBody ? /* @__PURE__ */ jsxRuntimeExports.jsx(TextMuted, { variant: "body1", children: suggestionBody }) : null
          ] }),
          actions?.onCloseSuggestion ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            IconButton,
            {
              size: "small",
              "aria-label": "close suggestion",
              onClick: actions.onCloseSuggestion,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(CloseIcon, { fontSize: "medium" })
            }
          ) : null
        ] }),
        actions ? /* @__PURE__ */ jsxRuntimeExports.jsxs(SuggestionActions, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            PrimaryActionButton,
            {
              variant: "contained",
              color: "primary",
              startIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaFileLinesIcon, {}),
              onClick: actions.onPrimary,
              children: actions.primaryLabel ?? aiAssistantDefaults.primaryActionLabel
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SecondaryActionButton,
            {
              variant: "outlined",
              color: "primary",
              startIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaChartLineIcon, {}),
              onClick: actions.onSecondary,
              children: actions.secondaryLabel ?? aiAssistantDefaults.secondaryActionLabel
            }
          )
        ] }) : null
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(InputContainer, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FaSparklesIcon, { color: "primary", fontSize: "medium" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        QuestionInput,
        {
          value: question,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AiSendButton, { "aria-label": "send question", onClick: handleSend })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(TipRow, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FaLightbulbIcon, { fontSize: "small", color: "warning", sx: { marginTop: "2px" } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TextMuted, { variant: "caption", children: tipText })
    ] })
  ] });
}
